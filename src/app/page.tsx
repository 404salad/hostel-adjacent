  ...
  return (
    <DefaultLayout2>
      <div className="mx-auto max-w-270">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-4 gap-3 py-5 grid-cols-2">
          <div className="p-1 h-full">
            <div className="overflow-hidden h-full flex flex-col justify-end shadow-lg bg-boxdark rounded-xl">
